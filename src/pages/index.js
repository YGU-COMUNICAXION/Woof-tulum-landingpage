        ...
        <div className="sobreWoof">
              ...
              <div className="leftHomeDiv">
                ...
                <div className="pata-description">
                  <p className="firstDescriptionDesk">
                    Nos preocupamos por tu mascota tanto como nos preocupamos
                    por la nuestra. Así que puedes encontrar en{" "}
                    <span>nuestro equipo</span> a{" "}
          ...
          {windowSize < 752 ? (
            <div id="sobre" className="sobreSecondSection">
              ...
              <p className="boldP">
                La peluquería canina es mucho más que el arreglo o la estética
                del animal.
              </p>
              <p className="lightP">
            ...
            <div id="sobre" className="sobreSecondSectionDesk">
              ...
              <div className="sobreFirstHorDivDesk">
                <div className="subtitleDescriptionDesk">
                  ...
                  <p className="lightP">
                    {" "}
                    Y esa, es la <span>principal razón</span> que nos ha llevado
                    a <span>fundar Woof Tulum</span>, una{" "}
                    <span>
                      peluquería canina especializada en cuidar y mimar
                    </span>{" "}
                    a las mascotas siguiendo un modelo de estética de bajo
                    estrés.
                  </p>
                </div>
                <img src={Perro2} />
          ...
          {windowSize < 752 ? (
            <div className="sobreThirdSection">
              ...
              <div className="manchasRow">
                <ManchasItem
                  image={Mancha3}
                  text={"Limpieza del canal auditivo"}
                />
                <ManchasItem
                  image={Mancha4}
          ...
          {windowSize < 752 ? (
            <div id="consejos" className="sobreSixthSection">
              <h2>
                Consejos para <span>antes</span> y <span1>después</span1> del
                baño{" "}
              </h2>
              <ConsejosCard
                text={
        ...
        <div id="servicios" className="servicios">
          <div className="serviciosFirstSection">
            ...
            <p className="serviciosFirstP">
              ...
              ocupamos de todas las necesidades <span>de aseo y baño</span> que
              tu perro pueda necesitar.
            </p>
            <p className="serviciosFirstP">
            ...
            <div className="serviciosSecondTextDiv">
              <p className="serviciosSecondText">
                Nuestros precios pueden variar según el tamaño, la raza de tu
                perro y sus necesidades específicas.
              </p>
              <p className="serviciosSecondText">
          ...
          {windowSize < 752 ? (
            <div id="servicioDomicilio" className="serviciosSecondSection">
              ...
              <ServiciosCard
                icon={Aseo}
                text={
                  "Aseo de primera calidad para su cachorro o perro adulto."
                }
            ...
            <div id="handstripping" className="serviciosThirdSectionDesk">
              <div className="handStrippingHorDiv">
                <div className="handInfo">
                  <h2>Hand Stripping</h2>
                  <p>
                    Se trata de una <span>muda artificial del pelo</span>.
                    Quitamos las capas que están a punto de caerse para que{" "}
                    <span>
                      no dificulte el crecimiento de la nuevas capas de pelo
                    </span>{" "}
                    y así <span>crezca mucho más fuerte</span>.
        ...
        <div id="instalaciones" className="instalaciones">
          <div className="instalacionesFirstSection">
            ...
            <p className="notaras">
              ...
              importante es la <span>responsabilidad</span> que tenemos con
              nuestros <span>amigos peludos.</span>
            </p>
            ...
            <p className="notaras">
              También vendemos <span>alimento y accesorios</span> para tus
              mascotas
            </p>
          </div>
        </div>
              ...
              <div id="cita" className="citaFirstSection">
                ...
                <div className="hazCitaDiv">
                  ...
                  <p className="hazCitaFirstP">
                    ...
                    <span>reserva la fecha y la hora</span> que más te
                    convengan. Te sugerimos <span>agendar</span> con al menos{" "}
